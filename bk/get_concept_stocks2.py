...
def get_all_concept_stocks():
    ...
    if os.path.exists("concept_boards2.csv"):
        concept_df = pd.read_csv("concept_boards2.csv", encoding="utf-8-sig")
    else:
        concept_df = ak.stock_board_industry_name_em()
        concept_df.to_csv("concept_boards2.csv", index=False, encoding="utf-8-sig")
    ...
    existing_codes = set()
    output_file = "concept_stocks2.csv"
