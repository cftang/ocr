...
def getText(filename):
    ...
    retgeneralocr = youtu.generalocr('img.jpg', data_type=0)
    # retgeneralocr = youtu.generalocr('C:/Users/wisdom/Downloads/2018-01-22 203722.png', data_type = 0)
    # print(retgeneralocr['items'][7]['words'][2]['character'].encode('iso8859-1').decode('utf-8'))
    time2 = time.time()
    ...
    # general ocr: use local image
    retgeneralocr = youtu.generalocr(filename, data_type=0)
    # retgeneralocr = youtu.generalocr('C:/Users/wisdom/Downloads/2018-01-22 203722.png', data_type = 0)
    # print(retgeneralocr['items'][7]['words'][2]['character'].encode('iso8859-1').decode('utf-8'))
    time2 = time.time()
